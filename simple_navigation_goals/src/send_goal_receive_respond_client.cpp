...
{
  ros::init(argc, argv, "send_goal_receive_respond_client");
  //if (argc != 4)
  //{
  ...
  ros::NodeHandle n;
  ros::Rate r(1);
  ros::ServiceClient client = n.serviceClient<simple_navigation_goals::GoalAndRespond>("abc");
  simple_navigation_goals::GoalAndRespond srv;
