...
class MoveBaseSquare():  
    def __init__(self):  
        ...
        # 创建四个导航点的位置（角度和坐标位置）  
        waypoints.append(Pose(Point(square_size, 2.0, 0.0), quaternions[0]))  
        waypoints.append(Pose(Point(square_size, square_size, 0.0), quaternions[1]))  
        waypoints.append(Pose(Point(2.0, square_size, 0.0), quaternions[2]))  
        waypoints.append(Pose(Point(2.0, 2.0, 0.0), quaternions[3]))  
